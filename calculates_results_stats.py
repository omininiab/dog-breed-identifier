...
# REVISED DATE: 
# PURPOSE: The function calculates_results_stats calculates the 
...
def calculates_results_stats(results_dic):
    ...
    # Create dictionary to store result statistics
    results_stats_dic = dict()

    # Calculate number of images processed
    results_stats_dic['n_images'] = len(results_dic)
    
    # Initialize the following stats to zero prior to calculation
    ...
    for key in results_dic:
        # Calculate number of dog images using is_dog value
        results_stats_dic['n_dogs_img'] = results_stats_dic['n_dogs_img'] + results_dic[key][3]
        # Calculate number of correctly classified images
        results_stats_dic['n_match'] = results_stats_dic['n_match'] + results_dic[key][2]

        if results_dic[key][3] == 1 and results_dic[key][4] == 1:
            # Calculate number of dog images correctly classified as dogs
            results_stats_dic['n_correct_dogs'] = results_stats_dic['n_correct_dogs'] + 1
            # Calculate number of correctly classified dog breeds
            results_stats_dic['n_correct_breed'] = results_stats_dic['n_correct_breed'] + results_dic[key][2]

        if results_dic[key][3] == 0 and results_dic[key][4] == 0:
            # Calculate number of non-dog images correctly classified as non-dogs
    ...
    # Calculate percentage of images correctly classified as dogs
