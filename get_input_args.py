...
# REVISED DATE: 
# PURPOSE:  Function that retrieves 3 command line inputs from the user using the Argparse Python module.
#           If the user fails to provide some or all of the 3 inputs, then the default values are used 
#           for the missing inputs. Command Line Arguments:
